...
def restaurant_review_stats(request, restaurant_id):
    ...
    chart_data = {
        'labels': ['Скорость доставки', 'Интенсивность вкуса', 'Качество продукции'],
        'datasets': [{
            'label': 'Средний рейтинг',
            'data': [delivery_speed_avg or 0, taste_intensity_avg or 0, product_quality_avg or 0],
            'backgroundColor': ['#FFCE56', '#36A2EB', '#FF7F0E'],
            'borderColor': ['#FFCE56', '#36A2EB', '#FF7F0E']
        }]
    }
    ...
    chart_data = {
        ...
        'datasets': [{
            ...
            'data': [(restaurant['delivery_speed_avg'] +
                        ...
                        restaurant['product_quality_avg']) / 3 or 0 for restaurant in reviews_by_restaurant],
...
def export_reviews_to_excel(request):
    ...
    columns = ['Ресторан', 'Пользователь', 'Отзыв', 'Рейтинг времени доставки', 'Рейтинг вкуса', 'Рейтинг качества продукта']
